...
export default function EventsSection() {
  ...
  return (
    <section id="events" className="relative w-full bg-[#06080D] text-slate-100 flex flex-col font-sans py-20 min-h-[800px]">
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[300px] bg-[#E5B93C]/[0.04] rounded-full blur-[120px] pointer-events-none z-0" />
      <div className="absolute top-32 right-1/4 w-[400px] h-[250px] bg-[#2458FF]/[0.05] rounded-full blur-[100px] pointer-events-none z-0" />
